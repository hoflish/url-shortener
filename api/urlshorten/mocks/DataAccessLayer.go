...
func (_m *DataAccessLayer) Fetch(ctx context.Context, shortURL string) (*models.URLShorten, error) {
...
func (_m *DataAccessLayer) Store(ctx context.Context, us *models.URLShorten) (*models.URLShorten, error) {
